...
<div class="card col-sm-8">
  <h5 class="card-body h6">TESTADOR DE CC #1</h5>
  <div class="card-body">
    <center><span>[#Kiler]</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">5496272778428214|00|2020|000</label>
</div>
</div>
<center>
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Made by Kiler Rose:
      <a href="https://discordapp.com/"> Killer Rose(Matador de Rosas)#2601</a>
    </div>
